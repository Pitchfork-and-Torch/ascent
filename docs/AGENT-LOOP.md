...
- Live Nexus Wire Lab 3.0 - composers for ROLE/TOOL/THINK/SAFETY and MM; Encoding guard sample rejects overlong LONG; 4-byte surrogate and nested agent-fence samples hard-fault
