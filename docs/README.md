...
| File | Use |
|------|-----|
| [ascent-infographic.png](ascent-infographic.png) | Full architecture card v3.0.1 Crystal Wire (README + site) |
...
**Current card:** ASCENT Nexus Wire Lab 4.0 Delay Hull · architecture **v4.0.0** (SkyPulse wire remains inside ascent-wire 2.2.0)
