...
**Current Nexus / architecture card:** `4.0.0` Delay Hull (TURN `0xC6` + CHUNK goldens; did not thaw Cont or P9)  
**Current wire packages:** `ascent-wire` 2.2.0 on PyPI and npm  
...
2. Nexus UI may bump independently (shipped 4.0.0 Delay Hull; Cont/P9 stay frozen)  
3. `ascent-wire` 2.2.0 published on PyPI and npm  
...
- CHUNK reassembly multi-stream stress tests beyond SPEC prose (goldens landed in ascent-wire 2.2.0; SPEC stays rc1)  
