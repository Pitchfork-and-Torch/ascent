...
**Current Nexus / architecture card:** `3.0.1` Crystal Wire parse-law (4-byte surrogate + agent-fence hard-faults; did not thaw Cont or P9)  
...
2. Nexus UI may bump independently (shipped 3.0.1 Crystal Wire; Cont/P9 stay frozen)  
