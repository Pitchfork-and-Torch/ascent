...
**SPEC:** 1.0.0-rc1 · **Nexus:** 4.0.0 Delay Hull · **ascent-wire:** 2.2.0 · MIT
...
```bash
# Release asset
pip install ascent_wire-2.2.0-py3-none-any.whl

# From git tag (Nexus release, package 2.2.0)
pip install "git+https://github.com/Pitchfork-and-Torch/ascent.git@v4.0.0"
```
...
| Registry | Status |
|----------|--------|
| **PyPI** `ascent-wire` | **Published 2.2.0** (2.1.0 stays up) |
| **npm** `ascent-wire` | **Published 2.2.0** (2.1.0 stays up) |
