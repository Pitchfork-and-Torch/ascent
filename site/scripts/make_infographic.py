...
def main() -> None:
    ...
    draw.text(
        (56, 28),
        f"ASCENT NEXUS  ·  Wire Lab 4.0 Delay Hull  ·  v{VERSION}  ·  MIT",
        font=f_badge,
        fill=(*mint, 255),
    )
    ...
    draw.text(
        (56, 1608),
        "Nexus 4.0: TURN 0xC6 contact window · one ADU each way · CHUNK reassembly · sim, not interactive Grok",
        font=f_tiny,
        fill=(*muted, 160),
    )
