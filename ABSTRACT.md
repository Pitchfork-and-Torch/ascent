...
SkyPulse PATHHINT (P2 `0xC5` schema `0x01`): required `path_id`, `next_capacity` (predicted sender bottleneck bits/s, not RF PHY), `freeze_until`, `confidence`, `ttl`; optional obstruction/elev. Fail-closed erase on CRC/short-RS fail, stale TTL, or unknown version. Light integrity on Starlink IP/QUIC (CRC or short RS); full RS(255,223) P9 is spool/deep-space only. Usage profile ASCENT-E-LEO vs ASCENT-D.
